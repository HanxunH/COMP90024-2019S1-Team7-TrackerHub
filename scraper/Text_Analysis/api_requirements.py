...
API_PORT = {"upload_tweet" : {"Port" : "api/tweet/", "Header": {"Content-Type" : "application/json", "X-API-KEY": API_KEY}},
            ...
            "download_tweet" : {"Port" : "api/tweet/untrained/text/", "Header": {"X-API-KEY": API_KEY}},
           	"update_tweet" : {"Port" : "api/tweet/trained/text/", "Header": {"Content-Type" : "application/json", "X-API-KEY": API_KEY}}
            }
